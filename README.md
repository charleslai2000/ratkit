...
```toml
[dependencies]
ratkit = { version = "0.2.17", features = ["all"] }
```
...
```toml
[dependencies]
ratkit = { version = "0.2.17", default-features = false, features = ["markdown-preview", "tree-view", "button"] }
```
...
```toml
ratkit = { version = "0.2.17", default-features = false, features = ["tree-view", "toast"] }
```
